/* Treiber für NuDAQ-Karte; sucht Basisadresse des AMCC-chips und stellt ein
 ...
 Copyright (C) 2000-2006 Christian Kurtsiefer <christian.kurtsiefer@gmail.com>
 ...
 ***********************
 ...
 Minor 2:  Beim Öffnen wird die DMA-engine reserviert (Interupt frei?)
	   ...
	   Kommando:  timer_set value (setzt den Taktgeber auf intern)
		      ...
		      NUDAQ_2_BYTES_READ          (Anzahl der per DMA
						   ...
						   truncated to 31 bits. A neg
						   number refers to an error.)
 ...
 Minor 3:  Wie Minor 2, aber gedacht als Gerät für die Koinzidnezeinheit.
           erlaubt als zusätzliche Kommandos das Setzten eines Hardwaretimers,
...
-------------------
 ...
 Minor 4:  soll analog dem minor gerät 2 eine kontinuierliche Ausgabe von
           Daten aus dem ringpuffer erlauben.
	   Das Bereitstellen des Puffers geschieht analog zu dem Gerät 2
	   mittels mmap-zugriff, folgende ioctl-kommandos gelten für dieses
	   Gerät:     timer_set value (setzt den Taktgeber auf intern)
		      ...
		      NUDAQ_4_BYTES_SENT          (Anzahl der per DMA
		                                   transferierten bytes)
		      NUDAQ_4_DITIMERS val       (setzt teilerverhältnis;
...
/* interrupt handler für minor device 2, 3 and 4 */
